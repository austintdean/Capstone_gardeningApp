...
const SummerPlantsPage = () => { 
    ...
    async function getSummerPlants(){
        try { let response = await axios.get("http://127.0.0.1:8000/api/plants/summer/");
...
export default SummerPlantsPage