...
const SpringPlantsPage = () => { 
    ...
    async function getSpringPlants(){
        try { let response = await axios.get("http://127.0.0.1:8000/api/plants/spring/");
...
export default SpringPlantsPage